...
const GooeyNav = ({
  ...
  const getIndexFromPathname = () => {
    const idx = items.findIndex((item) => item.href === pathname);
    return idx >= 0 ? idx : initialActiveIndex;
  };

  const [activeIndex, setActiveIndex] = useState(getIndexFromPathname);
  ...
  const handleClick = (e, index) => {
    ...
    runAnimation(e.currentTarget, index);
